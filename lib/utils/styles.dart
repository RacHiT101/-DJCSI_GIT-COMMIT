...
class Styles{
  ...
  static Color textColor = const Color(0xFF454545);
  static Color bgColor = const Color(0xFFFFE6C7);
  static Color lightOrangeColor = const Color(0xFFFF6000);
  static Color orangeColor = const Color(0xFFFF6000);
